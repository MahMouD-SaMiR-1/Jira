	...
	return (
		<div className="flex flex-col gap-y-4 col-span-1">
			<div className="bg-white border rounded-lg p-4">
				...
				<DottedSeparator className="my-4" />
				<ul className="grid gird-cols-1 lg:grid-cols-2 gap-4">
					{data.map((project) => (
						<li key={project.$id}>
...
interface MmebersListProps {
	data: Member[];
	total: number;
}

export const MemberList = ({ data, total }: MmebersListProps) => {
	const workspaceId = useWorkspaceId();
	...
	return (
		<div className="flex flex-col gap-y-4 col-span-1">
			<div className="bg-white border rounded-lg p-4">
				...
				<DottedSeparator className="my-4" />
				<ul className="grid gird-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
					{data.map((member) => (
						<li key={member.$id}>
